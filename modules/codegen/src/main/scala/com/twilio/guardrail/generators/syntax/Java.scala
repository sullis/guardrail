...
object Java {
  ...
  def completionStageType(of: Type): ClassOrInterfaceType =
    StaticJavaParser.parseClassOrInterfaceType("java.util.concurrent.CompletionStage").setTypeArguments(of)
